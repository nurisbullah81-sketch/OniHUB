...
-- ==========================================
-- 1. THE GUARDIAN (ZERO-BLINK TECHNOLOGY)
-- ==========================================
-- Method A: Instant Event-Driven Nuke (0.0001s reaction time)
...
-- Method B: Visual Blocker (Prevents rendering on screen)
task.spawn(function()
...
-- ==========================================
-- 3. TWEEN SYSTEM (ORIGINAL - JANGAN DIUTAK ATIK)
-- ==========================================
...
-- ==========================================
-- 4. AUTO STORE SYSTEM (ORIGINAL - JANGAN DIUTAK ATIK)
-- ==========================================
...
function _G.Cat.HopServer()
    ...
    warn("[CatHUB] [HOP] Menjalankan Sovereign V26 Hopper...")
    ...
    pcall(function()
        ...
        if not browser then isHopping = false return end
        ...
        if listArea then
            ...
            if not scrollFrame then isHopping = false return end
            ...
            for _, target in pairs(buttons) do
                if not Settings.AutoHop then break end -- Berhenti kalau AutoHop dimatiin
    ...
    task.wait(10) -- Jeda sebelum bisa hop lagi
    isHopping = false
end
        ...
        if Settings.AutoHop then
            pcall(function()
                ...
                if fruitCount == 0 then
                    ...
                    -- PENTING: Kalau ada buah, tutup UI Server biar ga nutupin layar!
                    CloseServerUI()
                end
            end)
        else
            -- Kalau AutoHop dimatiin, pastiin UI Server ketutup
            CloseServerUI()
        end
    end
end)
