...
-- 1. PASANG UI (UI.SaveSettings() dihapus biar kagak tabrakan)
UI.CreateToggle(Page, "Auto Hop Server", "Hop if no fruits or inventory full", Settings.AutoHop, function(s) Settings.AutoHop = s end)

-- 2. LOGIC HOP SERVER (MURNI DARI CODE LU, DIBIKIN RAPI)
