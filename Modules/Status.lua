...
-- 1. PASANG UI
local StatusTab = UI.CreateTab("Status", true) -- Tab pertama yang aktif
UI.CreateSection(StatusTab, "PLAYER STATUS")
_G.Cat.Labels.Level = UI.CreateLabel(StatusTab, "Level: ...", "Current level progress")
_G.Cat.Labels.Money = UI.CreateLabel(StatusTab, "Money: ...", "In-game currency balance")
_G.Cat.Labels.Fragments = UI.CreateLabel(StatusTab, "Fragments: ...", "Used for awakening")
_G.Cat.Labels.Bounty = UI.CreateLabel(StatusTab, "Bounty/Honor: ...", "PvP score tracking")

UI.CreateSection(StatusTab, "SERVER STATUS")
_G.Cat.Labels.Players = UI.CreateLabel(StatusTab, "Players: ...", "Currently in this server")
_G.Cat.Labels.Time = UI.CreateLabel(StatusTab, "Time: ...", "In-game day/night cycle")
_G.Cat.Labels.Moon = UI.CreateLabel(StatusTab, "Moon: ...", "Affects certain bosses & events")
_G.Cat.Labels.Fruits = UI.CreateLabel(StatusTab, "Spawned Fruits: 0", "Devil fruits on the map")

-- 2. LOGIC UPDATE (MURNI DARI CODE LU)
