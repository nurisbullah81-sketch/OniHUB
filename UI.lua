-- CatHUB SUPREMACY: UI Module v9.0
local UserInputService = game:GetService("UserInputService")
local CoreGui = game:GetService("CoreGui")
local TweenService = game:GetService("TweenService")
local HttpService = game:GetService("HttpService")

if CoreGui:FindFirstChild("CatHUB_v9") then CoreGui.CatHUB_v9:Destroy() end
...
function UI:Save() pcall(function() writefile("CatHUB_v9.json", HttpService:JSONEncode(self.Settings)) end) end
function UI:Load() 
    if isfile and isfile("CatHUB_v9.json") then 
        local s, d = pcall(function() return HttpService:JSONDecode(readfile("CatHUB_v9.json")) end)
...
Title.Text = "CATHUB SUPREMACY v9.0"
